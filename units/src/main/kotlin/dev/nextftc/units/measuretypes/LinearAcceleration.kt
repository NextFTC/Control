...
class LinearAcceleration(magnitude: Double, unit: LinearAccelerationUnit) :
    ...
    override fun unaryMinus(): LinearAcceleration {
        return LinearAcceleration(-magnitude, unit as LinearAccelerationUnit)
    }
    ...
    override fun times(multiplier: Double): LinearAcceleration {
        return LinearAcceleration(magnitude * multiplier, unit as LinearAccelerationUnit)
    }

    override fun div(divisor: Double): LinearAcceleration {
        return LinearAcceleration(magnitude / divisor, unit as LinearAccelerationUnit)
    }
