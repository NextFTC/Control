 ...
 *
 * This class represents energy values like joules, kilojoules, watt-hours, etc.
 * It supports arithmetic operations and conversions between different energy units.
 */
class Energy internal constructor(
    ...
    override fun times(multiplier: Double): Energy {
        return Energy(magnitude * multiplier, unit)
    }

    override fun div(divisor: Double): Energy {
        return Energy(magnitude / divisor, unit)
    }
