 ...
 *
 * The MulUnit automatically normalizes to use base units for internal calculations. For example,
 * if you create a MulUnit with Kilometers and Hours, it internally works with Meters and Seconds
...
open class MulUnit<N: Unit<N>, D: Unit<D>>(
    ...
    /**
     * The base MulUnit using the base units of both first and second.
     * For example, Kilometers⋅Hours would have a baseMulUnit of Meters⋅Seconds.
     */
