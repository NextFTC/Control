 ...
 *
 * The PerUnit automatically normalizes to use base units for internal calculations. For example,
 * if you create a PerUnit with Miles and Hours, it internally works with Meters and Seconds
 * (the base units), ensuring that conversions work correctly.
 *
...
open class PerUnit<N: Unit<N>, D: Unit<D>>(
    ...
    /**
     * The base PerUnit using the base units of both numerator and denominator.
     * For example, Miles per Hour would have a basePerUnit of Meters per Second.
     */
