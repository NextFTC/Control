 ...
 *
 * Supported units include joules (base unit), kilojoules, watt-hours, kilowatt-hours.
 * Energy is dimensionally equivalent to force × distance = mass × distance² / time².
 *
 * Note: While energy and torque have the same dimensions, they represent different
 * physical quantities - energy is a scalar, torque is a vector (moment).
 */
class EnergyUnit(
    baseUnit: EnergyUnit?,
    ...
    override fun of(magnitude: Double): Energy {
        return Energy(magnitude, this)
    }
